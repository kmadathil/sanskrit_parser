    ...
    if sentence != '':
      ...
      for word in sentence.strip().split(' '):
        ...
        if splits is None:
          ...
          # top_split = [str(x) for x in splits[0].split]
...
if __name__ == '__main__':
  text = "श्रुतिभगवतीचरणप्रतीका छन्दोविचितिरिति वेदाङ्गविदः समामनन्ति । अस्य चरणयुगलस्य गतिर् एव च्छन्दःसुषमेति तन्मर्मविदां प्रेक्षा ।"
