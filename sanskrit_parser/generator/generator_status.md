...
| 519 | 4.1.64 | पाककर्णपर्ण…उत्तरपदाच्च | jāti compounds ending in pāka/karṇa/parṇa/puṣpa/phala/mūla/vāla (?pAkAdi_uttara, read in-window — no llp) → NIz → ओदनपाकी, शङ्कुकर्णी, शालपर्णी, शङ्खपुष्पी, दासीफली, दर्भमूली, गोवाली. parṇa/puṣpa/mūla/vāla built as **live** compounds (uttara tagged ?pAkAdi_uttara per-instance via in_context); pāka/phala/karṇa kept preformed (sense collisions: ajādi / dvigu-ajādi / SK511 svāṅga =karRa) |
...
| SAlaparRI | f | SK519 (4.1.64) | [SAla, in_context(in_compound(parRa), "pAkAdi_uttara"), strI_abs] (live) → NIz → शालपर्णी |
| SaNKapuzpI | f | SK519 (4.1.64) | [SaNKa, in_context(in_compound(puzpa), "pAkAdi_uttara"), strI_abs] (live) → NIz → शङ्खपुष्पी (gen-pl ṇatva शङ्खपुष्पीणाम् — ṣ within the uttara, no boundary crossing) |
| dAsIPalI | f | SK519 (4.1.64) | dAsIPala (?pAkAdi_uttara, phala) → NIz → दासीफली (kept preformed — phala ↔ dvigu-ajādi) |
| darBamUlI | f | SK519 (4.1.64) | [darBa, in_context(in_compound(mUla), "pAkAdi_uttara"), strI_abs] (live) → NIz → दर्भमूली |
| govAlI | f | SK519 (4.1.64) | [go, in_context(in_compound(vAla), "pAkAdi_uttara"), strI_abs] (live) → NIz → गोवाली |
