...
**Last implemented:** **Bahuvrīhi minor कप् cluster** — SK890/5.4.152 (बहुदण्डिका), SK894/5.4.156 (बहुश्रेयान्), SK895/5.4.157 (सुभ्राता / मूर्खभ्रातृकः), SK896/5.4.159, SK897/5.4.160 (निष्प्रवाणिः), SK892/7.4.15 (बहुमालाकः/बहुमालकः). Required **widening 5.4.153's ऋतः arm** to a true ṛ-final test (`?svasrAdi` is the feminine gaṇa, so भ्रातृ/पितृ were missed) — zero regressions. 7.4.13/7.4.14 deliberately skipped (net no-op for कप्); two prohibition arms verified **vacuous** and documented as such rather than presented as working.

**Next to be implemented:** **B3/B4 remaining** — अप् 5.4.116 (pūraṇī pl), gandha 5.4.136/137, kakud 5.4.147–149, jambhā/dakṣiṇerma nipātanas (5.4.125/126). Then reciprocal इच् SK866/5.4.127 (केशाकेशि: needs 2.2.27 sarūpa + 6.3.137 + avyaya tagging, **not** reduplication — and it is what unlocks 6.4.146 ओर्गुणः / बाहूबाहवि). Then the formation deferrals needing **physical pūrva-nipāta (2.2.30)**: SK846/2.2.27, SK898–900/2.2.35–37, B0 reorder, B1 6.3.35/36/39. Latent gaps worth noting: **1.2.48's `?pum_abs` gate** (blocks upasarjana shortening — बहुनाडिः, and would make 7.4.14 load-bearing) and **5.4.153's नदी arm keying on `?NI` rather than the 1.4.3 saṁjñā** (excludes तन्त्री). Tatpuruṣa deferrals unchanged.
