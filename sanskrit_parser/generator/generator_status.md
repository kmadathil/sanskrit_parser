...
**Last implemented:** **Bahuvrīhi B2/B4 gap-fill** — SK871/5.4.133 वा संज्ञायाम् (optional अनङ् in a saṁjñā: शतधन्वा/शतधनुः) and the संख्येय cluster SK843/2.2.25 + SK851/5.4.73 डच् + SK844/6.4.142 (उपदशाः, आसन्नविंशाः, उपबहवः). Docs corrected on three counts: 8.4.28's `?nas_AdeSa` gate is **faithful, not a placeholder** (both SK859 and Vasu gloss 8.4.28 as नस्-specific); डच् is **not** accent-only; and 2.2.25 never needed the physical reorder. अगः is **deliberately unmodelled**, following the Bhāṣya's प्रत्याख्यान (see the SK856/857 row).

**Next to be implemented:** **B3/B4 remaining samāsānta** — reciprocal इच् SK866/5.4.127 (केशाकेशि: needs 2.2.27 sarūpa + 6.3.137 + avyaya tagging, **not** reduplication), minor कप् (5.4.152/153/156/157/159/160, 7.4.13–15), अप् 5.4.116 (pūraṇī pl). Then the B0–B2 formation deferrals that genuinely need the **physical pūrva-nipāta (2.2.30)**: SK846/2.2.27, SK898–900/2.2.35–37, B0 reorder, B1 6.3.35/36/39. Tatpuruṣa deferrals unchanged.
