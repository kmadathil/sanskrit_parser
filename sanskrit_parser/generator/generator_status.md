...
**Last implemented:** Tatpuruṣa samāsa, Phase T3 — **nañ-tatpuruṣa** (the negative न is pūrva): 2.2.6 नञ् saṁjñā (न + noun → pūrva ?samAsaPurva + ?naY, uttara ?samAsa + ?tatpuruza; reuses 1.2.43 upasarjana + 2.4.26 paravalliṅga, so the compound declines normally in the uttara's gender). The नञ् junction mutation of न runs in the samāsa pre-pass member-window (bahiranga: -1, the same (pūrva\|uttara) window 2.2.6 fires in — the uttara stem's first char is visible as `r`): **6.3.73 नलोपो नञः** (न → अ before a consonant → अब्राह्मणः) and **6.3.74 तस्मान्नुडचि** (न → अ + नुṭ, the न् prepended to the UTTARA — अश्व → नश्व — before a vowel → अनश्वः, अनजः). The नुṭ is kept on the uttara (not as an "an"-final pūrva) so 8.2.7 नलोपः प्रातिपदिकान्तस्य can't re-delete it. The नञ् avyaya `naY` (avyaya.py) had its surface corrected नञ्→न (the ञ् is an इत्). Details: SK-order rows 756/757/758 + `tatpuruza_plan.md`.

**Next to be implemented:** Tatpuruṣa Phase T4 onward — prādi/gati (T4), tatpuruṣa samāsānta (T5), gender exceptions (T-liṅga), composer/CLI (T-UI). See `tatpuruza_plan.md` for phasing + session prompts. **T3 deferrals:** the 6.3.75/6.3.77 prakṛtibhāva exceptions (नभ्राट्…/नगः — a fixed lexical set where न stays intact; Skipped table); अब्राह्मणेन is the correct instrumental (the ण of ब्राह्मण blocks the र-triggered ṇatva on the -ena न), so the nañ vibhakti sweep uses अनश्व (no र/ष trigger) to stay off that ṇatva-blocker corner. **T2 deferrals:** त्रिभुवनम् (cross-member ṇatva — त्रि's र would ṇatva-ise bhuvana's न across the pūrva/uttara boundary → त्रिभुवण; blocking it needs the 8.4.3 पूर्वपदात्संज्ञायाम् restriction, a pre-existing ṇatva-engine gap, same family as चोरभयेन); the full कल्याणी→कल्याण puṃvadbhāva ṅīp-strip (6.3.42 modelled as a saṁjñā with the masc form supplied); 2.1.33–35, 2.1.42–48, 2.2.9–11, and the स्तोकान्मुक्तः aluk. (Kāraka and strī/taddhita deferrals remain in the Skipped table.)
