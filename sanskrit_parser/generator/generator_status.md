...
| 868 | 5.4.129 | प्रसंभ्यां जानुनोर्ज्ञुः | Bahuvrīhi (**B4** samāsānta ādeśa, `bahiranga: -1`): प्र/सम् + जानु → ज्ञु → प्रज्ञुः (u-stem). Pre-pass uttara-substitution (`rc→""`, `r→"jYu"`), mirroring the tatpuruṣa 6.3.46 महत्→महा |
...
| 864–888 | 5.4.125–150, 6.1.66 | (bahuvrīhi samāsānta — ādeśa/lopa/nipātana, remaining) | For later (bahuvrīhi B4) — done: jñu (5.4.129 प्रज्ञुः) | Remaining: datṛ (5.4.141, needs the दतृ न्-declension द्विदन्), anaṅ (5.4.132 dhanus→dhanvan, n-stem), niṅ (5.4.134 jāyā→jani), pāda/kakud/gandha/hṛd substitutions + nipātanas; pre-pass uttara-substitution (`rc→""`, `r→…`) per `bahuvrihi_plan.md` |
