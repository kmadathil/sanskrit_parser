...
**Next to be implemented:** kāraka **Phase K1** (SK538–545: 1.4.50/51 + dvikarmaka gaṇas, 1.4.52/53 ṇyanta, 1.4.46–48, 2.3.4 — see karaka_plan.md §5; phases K2–K7 follow, K-UI any time after K0). Kāraka deferrals from K0: pre-pass `optional:` forking (first needed in K3 — the pre-pass asserts against optional -1 rules for now), the tiṅ sup-insertion branch (verbs enter as pre-formed padas), real abhidhāna detection (prayoga is an input tag). Strī/taddhita thread: SK 532-numbered taddhita section (4.1.78 अणिञोरनार्षयोर्… under the 4.1.76 तद्धिताः adhikāra); deferred: SK 508/509 (4.1.52/53 — antodātta-accent-conditioned ṅīṣ, await accent modelling) and SK 516 (4.1.61 वाहः, Vedic/narrow); the rest of 4.1.50–60 (SK506/507/510–515) is now **implemented** via neighbour-pada peeking — see implemented table; 4.1.46/4.1.47 (बहुश्/भुवश् छन्दसि, Vedic-only); earlier deferrals: SK 465-468 (7.3.46-49, northern variants); 4.1.31 रात्रेश्चाजसौ (no SK#); the vārttika **वुग्युटावुवङ्यणोः सिद्धौ वक्तव्यौ** (carves vuk-augment, yuṭ-augment, uvaṅ, yaṇ out of 6.4.22 — they remain siddha to other ābhīya rules; not yet implemented).
...
26 K0 cases from the SK commentary (SK532–537, 559–561, 606): हरिं भजति (+ dual/
plural/napuṁsaka), रामो हरिं भजति, हरिः सेव्यते, रामेण सेव्यते, बाणेन (karaṇa, both
prayogas + plural), हे राम/हरे/हरयः, रामस्य पुत्रः (+ plural śeṣa, śeṣa-in-verb-
