...
**Last implemented:** Tatpuruṣa samāsa, Phase T2 — **karmadhāraya** (samānādhikaraṇa): 2.1.57 विशेषण (नीलोत्पलम्, कृष्णसर्पः), 2.1.49 पूर्वकाल (स्नातानुलिप्तः), 1.2.42 saṁjñā, 6.3.42 puṃvadbhāva (कल्याणप्रियः), 2.2.38 kaḍāra; and **dvigu** (saṅkhyā-pūrva): 2.1.52 saṁjñā/formation → sets ?dvigu (पञ्चगवम्, त्रिलोकम्), 2.4.1 samāhāra → napuṁsaka sg, 5.4.92 go-final ṬaC samāsānta (पञ्चगवम्). The existing 4.1.21 (SK479) ṅīp now fires on a **real dvigu** — त्रिलोकी derives from त्रि+लोक via 2.1.52's ?dvigu, not the in_compound shim (which still stands). Engine fix: `_commit_samasa_napum` locks the samāsa gender (?samasa_liNga_locked) so the wac samāsānta's hard-coded ?pum can't masculinise a samāhāra dvigu (पञ्चगवम्, not पञ्चगवः). Details: SK-order rows 726/729–731/736/745/746/751 + `tatpuruza_plan.md`.

**Next to be implemented:** Tatpuruṣa Phase T3 onward — nañ (T3), prādi/gati (T4), tatpuruṣa samāsānta (T5), gender exceptions (T-liṅga), composer/CLI (T-UI). See `tatpuruza_plan.md` for phasing + session prompts. **T2 deferrals:** त्रिभुवनम् (cross-member ṇatva — त्रि's र would ṇatva-ise bhuvana's न across the pūrva/uttara boundary → त्रिभुवण; blocking it needs the 8.4.3 पूर्वपदात्संज्ञायाम् restriction, a pre-existing ṇatva-engine gap, same family as चोरभयेन); the full कल्याणी→कल्याण puṃvadbhāva ṅīp-strip (6.3.42 modelled as a saṁjñā with the masc form supplied); 2.1.33–35, 2.1.42–48, 2.2.9–11, and the स्तोकान्मुक्तः aluk. (Kāraka and strī/taddhita deferrals remain in the Skipped table.)
