...
| Category | Count |
|---|---|
| Sutras implemented | 323 |
| Sutras skipped / deferred | 51 |
| Sutras uncatalogued / not yet planned | ~67 |
| **Total sutras accounted for** | **~431** |
| Stems with full vibhakti test tables | 190 |
...
| 470 | 4.1.15 | टिड्ढाणञ्द्वयसज्दघ्नञ्मात्रच्तयप्ठक्ठञ्कञ्क्वरपः | ṅīp for a-final taddhita stems (apavāda to 4.1.4 ṭāp). Shared tag ?NIp_taddhita. Working — 7 affixes: aṇ (ऐन्द्री), añ (औत्सी), dvayasac/daghnac/mātrac (ऊरुद्वयसी/ऊरुदघ्नी/ऊरुमात्री), tayap (पञ्चतयी), kañ (यादृशी, reuses kaY). Partial — 5 affixes deferred: ṭiṭ, ḍha, ṭhak, ṭhañ, kvarap (see Skipped) |
| 471 | 4.1.16 | यञश्च | ṅīp after yañ-final (?yaY), apavāda to 4.1.4. gārgya → +ṅīp → SK472 → गार्गी |
| 472 | 6.4.150 | हलस्तद्धितस्य | taddhita ya-kāra (yañ), upadhā + after hal, elided before ṅīp ī. bahiranga:1 (fires before 6.4.148). गार्गी (gārgya→gārga→gārg+ī), declines nadī-type |
| 1170 | 7.3.50 | ठस्येकः | (out-of-SK-order scaffolding) ठ of a taddhita affix → इक. Added for SK470's ṭhak/ṭhañ arm; those forms (आक्षिकी/लावणिकी) deferred pending an 8.2.29 fix, so 7.3.50 currently exercised by no test |
...
| 470 | 4.1.15 | टिड्ढाणञ्… (ṭiṭ/ḍha/ṭhak/ṭhañ/kvarap arms) | Partial — 5 of 12 affixes deferred (ṅīp rule + 7 affixes done) | ṭiṭ: the only ṭ-it affix (wac) is pum-only and not tagged krt/tadDita, so its ṭ-it is never propagated to the merged stem — a +w condition would be dead code; needs ṭ-it propagation + a feminine ṭit derivation. ṭhak/ṭhañ (आक्षिकी/लावणिकी): 7.3.50 ṭha→ika added but the vowel-initial ика exposes an **8.2.29 misfire** (deletes k of kṣ in akṣ\|ika) + ṇatva gemination — needs an 8.2.29 condition fix. ḍha (सौपर्णेयी): needs the ḍh→eya arm of 7.1.2 (SK475). kvarap (इत्वरी): needs tuk augment 6.1.71 (ह्रस्वस्य पिति कृति तुक्). Affix defs (Wak/WaY/Qhak/kvarap) present + tagged; only the substitution/augment prerequisites pending |
