...
**Last implemented:** SK 483/484/485/486 — 5.4.131/4.1.25/4.1.26/4.1.27 (ūdhas-bahuvrīhi feminine cluster + SK486 hāyana vārttika): new stems `UDas` (tagged ?uDanta), `kuRqa`, `Gawa`, `ati` (avyaya), `dAman` (?dAman), `hAyana` (?hAyana). SK483 substitutes अनङ् (final 's' of UDas → 'n') in bahuvrīhi+feminine; SK234 (6.4.134) then drops -an upadhā 'a' before ī giving kuṇḍodhnī, ghaṭodhnī, dvyūdhnī, atyūdhnī. SK484 selects ṅīṣ (overrides 4.1.4 / 4.1.13). SK485 (apavāda to 4.1.25) selects ṅīp for saṃkhyādi / avyayādi bahuvrīhi via test-composer ?saMKyAdi / ?avyayAdi tags. SK486 selects ṅīp for दामन्-final (द्विदाम्नी) or हायन-final in age sense (द्विहायनी, non-age द्विहायना ramā). SK486 vārttika (`4.1.27.1`) substitutes upadhā n→ṇ for tri/catur+hāyana in age sense via ?triCatur tag → त्रिहायणी, चतुर्हायणी (non-age त्रिहायना keeps न). One engine correction in the pūrvāparayoḥ section: 6.1.87 (आद्गुणः) now strips `sarvanAmasTAna` from the surviving guṇa-merged suffix (`orp: -sarvanAmasTAna`) so downstream aṅga rules keyed on that tag — notably 6.4.8 — do not re-fire on the n-final surface that ṭāp + 6.1.87 leaves behind (e.g. hāyanā + au → hāyan|e). Broader pūrvāparayoḥ refactor pending.
**Next to be implemented:** SK 487 (4.1.29 नित्यं संज्ञाछन्दसोः); deferred: SK 465-468 (7.3.46-49, northern variants); the vārttika **वुग्युटावुवङ्यणोः सिद्धौ वक्तव्यौ** (carves vuk-augment, yuṭ-augment, uvaṅ, yaṇ out of 6.4.22 — they remain siddha to other ābhīya rules; not yet implemented).
...
| Category | Count |
|---|---|
| Sutras implemented | 341 |
| Sutras skipped / deferred | 49 |
| Sutras uncatalogued / not yet planned | ~67 |
| **Total sutras accounted for** | **~445** |
| Stems with full vibhakti test tables | 222 |
...
| paYcASvA | f | SK480 Dvigu+tadDita-luk non-parimāṇa → ṭāp | [as_purva_pada(paYca), luk_sup, in_context(in_compound(aSva), "dvigu"), luk_tadDita, strI_abs]; aśva is also in ajādi-gaṇa (4.1.4.1 prabalatva would have given ṭāp too) — both paths concur on पञ्चाश्वा |
