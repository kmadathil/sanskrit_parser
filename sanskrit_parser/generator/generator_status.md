...
**Last implemented:** **Bahuvrīhi Phases B0–B4 (partial) + B-UI.** B0 (SK829/830): spine + core formation + the one new mechanism, **anyapadārtha (external-referent) gender** (`?referent_*` + `?samasa_liNga_locked`); पीताम्बरः/पीताम्बरा/पीताम्बरम्. B1 (SK831/6.3.34 + prohibitions): puṁvadbhāva दीर्घजङ्घा/ब्राह्मणीभार्यः. B2 (SK848/2.2.28 + 6.3.82/83 saha; SK845/2.2.26 diś): सपुत्रः/सहपुत्रः, दक्षिणपूर्वा. **B3 samāsānta** (generalized `_SAMASANTA_AFFIXES` map): कप् core (SK891/5.4.154 बहुयशस्कम्/बहुयशः, SK889/5.4.151 व्यूढोरस्कः, SK893/5.4.155 saṁjñā), षच् (SK852/5.4.113 दीर्घसक्थः, SK854/5.4.115 द्विमूर्धः), अप् (SK855/5.4.117 बहिर्लोमः), इच् (SK867/5.4.128 द्विदण्डि). **B4 ādeśa/lopa/nipātana** (pre-pass uttara-substitution): jñu (SK868/5.4.129 प्रज्ञुः, SK869/5.4.130 opt ऊर्ध्वज्ञुः), anaṅ (SK870/5.4.132 सुधन्वा), anic (SK863/5.4.124 कल्याणधर्मा), गन्ध→id (SK874/5.4.135 सुगन्धिः), पाद (SK879/5.4.140 द्विपात्), kakud (SK884/5.4.146 प्राप्तककुत्), हृद् (SK888/5.4.150 सुहृत्). **B-UI:** CLI `--referent-linga <pum|strI|napum>` (`cmd_line.prepare_bahuvrihi`) + Vākya-Composer API (`/api/karaka` `referent_linga` → `run_karaka`/`_apply_bahuvrihi`) + a referent-liṅga dropdown in `karaka.html`; the composer already renders the `?bahuvrIhi` compound type. `test_samasa_bahuvrihi.py` (39 cases, incl. a CLI smoke test). Detail: the 5.4.113/115/117/128–150/151/154/155 + 6.3.34/… + 2.2.24/26/28 rows + `bahuvrihi_plan.md`.

**Next to be implemented:** **B3/B4 remaining samāsānta** (all need a small engine step, not more YAML) — the ā-stem→i/a-stem substitutions (अच् नासिका→नस् 5.4.118/119 + 8.4.3/28 ṇatva, niṅ जाया→जानि 5.4.134 + 6.1.66) need **sup re-insertion after a class-changing substitution**; असिच् (5.4.122) + the masc s-stem बहुयशाः need the **6.4.14 dīrgha under gender-override**; datṛ (5.4.141 द्विदन्) needs the **दतृ न्-declension**; डच् (5.4.73) is accent-only; reciprocal इच् (5.4.127 केशाकेशि) needs reduplication; minor कप् (5.4.152/153/156/157/159/160, 7.4.13–15) + अप् 5.4.116 (pūraṇī pl). Also: B2 SK843/2.2.25 (→ḍac), SK846/2.2.27 (→ic), SK898–900/2.2.35–37 (vyadhikaraṇa + physical pūrva-nipāta 2.2.30); B0 physical reorder; B1 6.3.35/36/39. Tatpuruṣa deferrals unchanged.
...
| Category | Count |
|---|---|
| Sutras implemented | 578 |
| Sutras skipped / deferred | 171 |
...
| 891 | 5.4.154 | शेषाद्विभाषा | Bahuvrīhi (**B3** samāsānta कप्, `bahiranga: -1`, `optional`): a residual (śeṣa) bahuvrīhi OPTIONALLY takes कप् → बहुयशस्कम् / बहुयशः. Generalized samāsānta: sets `?samasanta_kap`, and `_insert_samasanta` (`_SAMASANTA_AFFIXES` map) inserts `kap` (mirroring `?samasanta_TaC`→`wac`). Gated on the composer intent `?Seza_kap` (śeṣa-kap is speaker-optional, not wanted on every bahuvrīhi); 5.4.155 overrides it |
| 889 | 5.4.151 | उरःप्रभृतिभ्यः कप् | Bahuvrīhi (**B3** samāsānta कप्, `bahiranga: -1`): an उरस्-prabhṛti stem (`?uras_praBfti`) final in a bahuvrīhi takes कप् (nitya) → व्यूढोरस्कः. Sets `?samasanta_kap` |
...
| 832/844/851/856–862/866/890/894–897 | 5.4.73,116,118–122,127,152,153,156,157,159,160, 7.4.13–15, 6.4.142/146, 8.4.3/28 | (bahuvrīhi samāsānta — affix insertion, remaining) | For later (bahuvrīhi B3 cont.) — done: कप् core (5.4.151/154/155), षच् (5.4.113/115), अप् (5.4.117), इच् (5.4.128), अनिच् (5.4.124 कल्याणधर्मा) | Remaining families: अच् (5.4.118/119 नासिका→नस् — the ā-stem→a-stem substitution mismatches the inserted sup → प्रनस without visarga, AND the 8.4.3/28 ṇatva does not fire across the compound; needs sup re-insert + compound ṇatva), असिच् (5.4.122, s-stem dīrgha gap), डच् (5.4.73, accent-only surface), इच् reciprocal (5.4.127, needs reduplication), अप् 5.4.116 (pūraṇī pl), minor कप् (5.4.152/153/156/157/159/160, 7.4.13–15). Each is one `_SAMASANTA_AFFIXES` entry + a Pratyaya + a rule |
| 864–888 | 5.4.125–150, 6.1.66 | (bahuvrīhi samāsānta — ādeśa/lopa/nipātana, remaining) | For later (bahuvrīhi B4) — done: jñu (5.4.129/130), anaṅ (5.4.132 सुधन्वा), anic (5.4.124 कल्याणधर्मा), gandha→id (5.4.135), pāda (5.4.140), kakud (5.4.146 प्राप्तककुत्), hṛd (5.4.150) | Remaining, deferred on declension gaps: datṛ (5.4.141 — दतृ न्-decl., engine gives द्विदत्), niṅ (5.4.134 jāyā→jani — the ā→i-stem substitution mismatches the inserted sup → जानि without visarga; needs 6.1.66 + sup re-insert), kakud 5.4.147–149, gandha 5.4.136/137, dhanus 5.4.133 (the शतधनुः fork needs suppressing nitya 5.4.132), jambhā/dakṣiṇerma nipātanas (5.4.125/126) |
