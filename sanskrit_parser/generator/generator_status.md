...
**Last implemented:** Tatpuruṣa prakaraṇa **completeness audit** (SK 684–828 = 145 sutras). Every sutra is now accounted for — **0 unaccounted**: 41 implemented (incl. the dvigu sutras SK685/2.1.23, SK728/2.1.51, SK727/2.1.50 documented as *fused into* SK730/2.1.52) + the rest in explicit grouped Skipped rows (ṣaṣṭhī+kṛt 2.2.12–17/20–22, lexical-gaṇa 2.1.53–72, gati long-tail 1.4.62–79, specialized samāsāntas 5.4.88–105/6.3.47–49, saṃjñā-domain gender/vacana 2.4.20–27/1.2.58–63). Added the missing test for **SK751/2.2.38 कडाराः** (कडारपुरुषः); noted SK789/6.4.145's dvyahna coverage. All tatpuruṣa + avyayībhāva test labels now carry SK numbers (`<phase>-<form>-SK<n>-<a.p.n>`). **Prior work:** Tatpuruṣa **T4/T5 corrections**. (1) **SK761/2.2.18 कुगतिप्रादयः is now correctly NITYA** — dropped the wrong `?samAsa_vivakza` "only-when-intended" gate (that framing was vibhāṣā): prādi/gati/ku compound *nitya* (aswapada-vigraha कुपुरुष=कुत्सितः पुरुषः), fired by the semantic-sense window trigger like the nitya avyayībhāvas (SK652/2.1.6); ?nitya marks the class → प्राचार्यः forms with NO vivakza. (2) **SK762/1.4.61 ऊर्यादिच्विडाचश्च is now a REAL gati-saṁjñā** (was faked via intrinsic ?gati): 1.4.61 (?UryAdi→gati) → ऊरीकृतम्, + SK768/1.4.67 पुरोऽव्ययम् (=puras→gati, now the real source of puras's gati driving 8.3.40 पुरस्कृतम् — no longer intrinsic) + SK769/1.4.68 अस्तं च (=astam→gati). (3) **SK787/5.4.87 अहस्सर्वैकदेशसंख्यातपुण्याच्च रात्रेः** (was deferred): a रात्रि-final tatpuruṣa → रात्र (i-lopa 6.4.148, via the ?samasanta_TaC path), and **SK814/2.4.29 रात्राह्नाहाः पुंसि generalized to the रात्रि arm** → masc **पुण्यरात्रः** with a full vibhakti sweep — upgrading 2.4.29 from structure-only to a real surface. Details: SK-order rows 761/762/787/814 + `tatpuruza_plan.md`.

**Next to be implemented:** The tatpuruṣa prakaraṇa (SK 684–828) is complete for the implemented scope; next is the following samāsa type (bahuvrīhi, SK 829+). **T4 deferral:** upapada (2.2.19 उपपदमतिङ् / 3.1.92) — needs the kṛt-pratyaya machinery (कुम्भकारः = कुम्भ+√कृ+अण्), out of samāsa scope; the 1.4.61 cvi (X→Xī) / ḍāc denominal derivations (need denominal-affix machinery) and the gati long-tail (1.4.66, 1.4.70–79) — only ऊर्यादि/पुरस्/अस्तम् (1.4.61/67/68) are REAL rules feeding 2.2.18. **T5 deferrals:** the ahar/sakhi arms of 5.4.91 (द्व्यहः — the ahar टच् collides with the existing dvyahna न्-retention, which keeps the samāsānta wac non-ट-marked → द्व्यह्न, SK238), 5.4.86 अङ्गुलि / 5.4.94 an-final / 5.4.101 khārī (stems not added); द्विरात्रः (संख्या pūrva → समाहार dvigu, whose napuṁsaka 2.4.1 vs रात्राह्नाहाः पुंसि 2.4.29 priority is a separate carve-out — पुण्यरात्रः avoids it). **T-liṅga deferrals:** 2.4.19 तत्पुरुषोऽनञ्कर्मधारयः (napuṁsaka only in the 2.4.17 saṃjñā-doubtful domain — inert without saṃjñā tagging, and would wrongly napuṁsaka-ise ordinary masc tatpuruṣas), 2.4.30 अपथं नपुंसकम् (needs the pathin अच् samāsānta 5.4.74), 2.4.31 अर्धर्चाः पुंसि च (needs the अर्धर्चादि stems); the ahan-arm द्व्यहः a-stem surface awaits the ahar टच् (2.4.29's रात्रि arm now has the real पुण्यरात्रः surface). **T3 deferrals:** the 6.3.75/6.3.77 prakṛtibhāva exceptions (नभ्राट्…/नगः; Skipped table); अब्राह्मणेन is the correct instrumental (the ण of ब्राह्मण blocks the र-triggered ṇatva on the -ena न), so the nañ vibhakti sweep uses अनश्व. **T2 deferrals:** त्रिभुवनम् (cross-member ṇatva needs 8.4.3, a pre-existing engine gap, same family as चोरभयेन); the full कल्याणी→कल्याण puṃvadbhāva ṅīp-strip; 2.1.33–35, 2.1.42–48, 2.2.9–11, स्तोकान्मुक्तः aluk. (Kāraka and strī/taddhita deferrals remain in the Skipped table.)
...
| Category | Count |
|---|---|
| Sutras implemented | 552 |
| Sutras skipped / deferred | 161 |
