...
**Last implemented:** SK 480/481/482 — 4.1.22/23/24 (tadDita-luk Dvigu niṣedha/niyama/vibhāṣā): new `luk_tadDita` Pratyaya (empty, ?tadDita+?luk_tadDita); `?luk_tadDita` propagates under the aṅga guard in `join_objects`; semantic class tags (`parimARa`, `bistAdi`, `kARqa`, `puruza`, `kzetre`, `pramARe`) propagate from both first and last in `join_objects`. SK480 blocks ṅīp (ṭāp) for non-parimāṇa or bistāḍi-class Dvigus (पञ्चाश्वा, द्विबिस्ता, द्व्याचिता, द्विकम्बल्या; counter द्व्याढकी keeps ṅīp); SK481 restricts the prohibition to kṣetra sense for kāṇḍa-final (द्विकाण्डा क्षेत्रभक्तिः vs. द्विकाण्डी रज्जुः); SK482 optionally re-enables ṅīp for puruṣa+pramāṇa (द्विपुरुषी ~ द्विपुरुषा), overrides `4.1.21` directly so the optional-skip branch falls back to SK480's ṭāp.
**Next to be implemented:** SK 483 (5.4.131 ऊधसोऽनङ्); deferred: SK 465-468 (7.3.46-49, northern variants); the vārttika **वुग्युटावुवङ्यणोः सिद्धौ वक्तव्यौ** (carves vuk-augment, yuṭ-augment, uvaṅ, yaṇ out of 6.4.22 — they remain siddha to other ābhīya rules; not yet implemented).
