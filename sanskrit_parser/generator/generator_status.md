...
**Last implemented:** Tatpuruṣa samāsa, Phase T1 — the remaining five vibhakti-tatpuruṣas: tṛtīyā (2.1.30–32), caturthī (2.1.36), pañcamī (2.1.37–39), **ṣaṣṭhī 2.2.8 राजपुरुषः** (the canonical case) + 2.2.1 pūrvāpara/ekadeśī, saptamī (2.1.40–41). Same T0 shape (pūrva ?viBakti_N + ?samAsa_vivakza → +samAsaPurva; uttara-class → +samAsa +tatpuruza; 2.4.71 luk, 2.4.26 gender). Engine fix: 2.4.71 now clears the stale `?Ba` (1.1.63 न लुमताङ्गस्य) so an-stem pūrvas take 8.2.7 न-lopa (राजन्→राज) not 6.4.134 (राक्…). Derives राजपुरुषः, धान्यार्थः, चोरभयम्, अक्षशौण्डः, मासपूर्वः, पूर्वकायः + masc (धान्यार्थ) and napuṁsaka (जीवसुख) vibhakti sweeps. Details: SK-order table rows 692–725/2.2.1/2.2.8 + `tatpuruza_plan.md`.

**Next to be implemented:** Tatpuruṣa Phase T2 onward — karmadhāraya/dvigu (T2, incl. 2.1.23), nañ (T3), prādi/gati (T4), samāsānta (T5), gender exceptions (T-liṅga), composer/CLI (T-UI). See `tatpuruza_plan.md` for phasing + session prompts. **Known limitation (deferred):** cross-member/uttara-internal ṇatva inside a *declining* compound does not fire (राजपुरुषेण surfaces as राजपुरुषेन) — a pre-pipeline samhitā-merge gap, first visible now that tatpuruṣa declines; T1 sweeps use ṇatva-safe stems, as T0 did. (Kāraka and strī/taddhita deferrals remain in the Skipped table.)
...
| 701 | 2.1.39 | स्तोकान्तिकदूरार्थकृच्छ्राणि क्तेन | Tatpuruṣa (**T1**): a स्तोक/अन्तिक/दूर/कृच्छ्र-class pañcamī pūrva (?stoka_gaRa) + a ?kta uttara → स्तोकान्मुक्तः |
...
| 719 | 2.1.42–48 | ध्वाङ्क्षेण… / पात्रेसमितादयश्च … | Deferred (tatpuruṣa T1) — saptamī long tail; specialized lexical classes; 2.1.40 (अक्षशौण्डः) + 2.1.41 implemented | ध्वाङ्क्षक्षेत्रम्, पात्रेसमिताः … |
| 8.4.1 | 8.4.1/8.4.2 | रषाभ्यां नो णः समानपदे (cross-member) | Deferred (tatpuruṣa T1) — ṇatva does not fire on/across a **declining** compound's members (राजपुरुषेण → राजपुरुषेन; कृष्णपुरुषेन); a pre-pipeline samhitā-merge gap first visible now that tatpuruṣa declines. T1 sweeps use ṇatva-safe stems, as T0 did | any tatpuruṣa with a र/ष trigger + न-bearing sup |
