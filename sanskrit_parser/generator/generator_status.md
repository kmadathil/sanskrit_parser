...
**Last implemented:** **Bahuvrīhi Phases B0–B2 + B3 (kap core).** B0 (SK829/2.2.23 + SK830/2.2.24): spine + core formation + the one new mechanism, **anyapadārtha (external-referent) gender** (`?referent_*` + `?samasa_liNga_locked`); पीताम्बरः/पीताम्बरा/पीताम्बरम्. B1 (SK831/6.3.34 + prohibitions 6.3.37/38/40/41): puṁvadbhāva दीर्घजङ्घा / ब्राह्मणीभार्यः. B2 (SK848/2.2.28 + 6.3.82/6.3.83 saha; SK845/2.2.26 diś): सपुत्रः/सहपुत्रः, दक्षिणपूर्वा. **B3 (kap core):** the samāsānta mechanism is generalized (`_insert_samasanta` `_SAMASANTA_AFFIXES` map, `?samasanta_kap`→`kap` alongside `?samasanta_TaC`→`wac`) + the कप् family core — SK891/5.4.154 (optional, बहुयशस्कम्/बहुयशः), SK889/5.4.151 (व्यूढोरस्कः), SK893/5.4.155 (saṁjñā prohibition). `test_samasa_bahuvrihi.py` (23 cases). Detail: SK829/830, 6.3.34/…, 2.2.28/…, 5.4.154/151/155 rows + `bahuvrihi_plan.md`.

**Next to be implemented:** **B3 remaining affix families** — ap/ac/ṣac/ḍac/asic/anic/ic + the minor कप् rules (SK832–835,844,847,851–863,866–867,890,894–897; 5.4.152/153/156/157/159/160, 7.4.13–15, 6.4.142/146, 8.4.3/28), each one `?samasanta_*` marker + a Pratyaya in `_SAMASANTA_AFFIXES`; then **B4** (samāsānta ādeśa/lopa/nipātana, SK864–888) + **B-UI** (session prompts in `bahuvrihi_plan.md`; may be split by affix family). Deferred (Skipped rows): B2 SK843/2.2.25 saṅkhyā (→ ḍac), SK846/2.2.27 sarūpa (→ ic), SK898–900/2.2.35–37 word order (vyadhikaraṇa + physical pūrva-nipāta 2.2.30); B0 physical reorder; B1 6.3.35/36/39; the masc s-stem 6.4.14 dīrgha under gender-override (बहुयशाः — B3 uses a neuter referent to avoid it). Tatpuruṣa deferrals unchanged.
...
| 832–897 | 5.4.113–160, 7.4.13–15, 6.4.142/146, 8.4.3/28 | (bahuvrīhi samāsānta — affix insertion, remaining) | For later (bahuvrīhi B3 cont.) — the कप् core (5.4.151/154/155) is done | The other affix families ap/ac/ṣac/ḍac/asic/anic/ic + the minor कप् rules (5.4.152/153/156/157/159/160, 7.4.13–15) — each is one `?samasanta_*` marker + a Pratyaya in `_SAMASANTA_AFFIXES` (mechanism generalized in B3); may be split by affix family per `bahuvrihi_plan.md` |
| 864–888 | 5.4.125–150, 6.1.66 | (bahuvrīhi samāsānta — ādeśa/lopa/nipātana) | For later (bahuvrīhi B4) | jñu/anaṅ/niṅ/id/pad/datṛ/kakud/hṛd stem substitutions + nipātanas; pre-pass uttara-substitution rules per `bahuvrihi_plan.md` |
