...
**Last implemented:** **Bahuvrīhi Phases B0–B2.** B0 (SK829/2.2.23 + SK830/2.2.24): spine + core samānādhikaraṇa formation + the one new mechanism, **anyapadārtha (external-referent) gender** (`?referent_*` + `?samasa_liNga_locked`, not the uttara's — contrast SK812/2.4.26); पीताम्बरः/पीताम्बरा/पीताम्बरम्. B1 (SK831/6.3.34 puṁvadbhāva + prohibitions 6.3.37/38/40/41): fem pūrva → masc bhāṣitapuṁska form (दीर्घजङ्घा), prohibitions override it (ब्राह्मणीभार्यः …). B2 (SK848/2.2.28 + SK849/6.3.82 + SK850/6.3.83 saha; SK845/2.2.26 diś): सह + noun → सपुत्रः/सहपुत्रः (optional saha→sa; āśis सहपुत्राय), direction-names → दक्षिणपूर्वा. `test_samasa_bahuvrihi.py` (20 cases). Detail: SK829/830, 6.3.34/37/38/40/41, 2.2.28/6.3.82/6.3.83/2.2.26 rows + `bahuvrihi_plan.md`.

**Next to be implemented:** Bahuvrīhi **B3 — samāsānta affix-insertion** (the full ap/ac/kap/ḍac/ṣac/asic/anic/ic set — SK832–835,844,847,851–863,866–867,889–897), via a generalized `?samasanta_*` marker + `_insert_samasanta`; then B4 (ādeśa/lopa/nipātana) + B-UI (session prompts in `bahuvrihi_plan.md`). Deferred: B2 SK843/2.2.25 saṅkhyā (→ ḍac, B3), SK846/2.2.27 sarūpa (→ ic, B4), SK898–900/2.2.35–37 word order (vyadhikaraṇa + physical pūrva-nipāta 2.2.30); B0 physical reorder; B1 6.3.35/36/39 — all Skipped rows. Tatpuruṣa deferrals unchanged — see the Skipped table + `tatpuruza_plan.md`.
...
| Category | Count |
|---|---|
| Sutras implemented | 563 |
| Sutras skipped / deferred | 169 |
