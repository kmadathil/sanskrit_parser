...
**Last implemented:** **Bahuvrīhi Phases B0 + B1.** B0 (SK829/2.2.23 + SK830/2.2.24): the spine + core samānādhikaraṇa formation + the one new mechanism, **anyapadārtha (external-referent) gender** — a bahuvrīhi is exocentric, declining in the composer-supplied referent gender (`?referent_*` + `?samasa_liNga_locked`), not the uttara's (contrast SK812/2.4.26); पीताम्बरः/पीताम्बरा/पीताम्बरम्. B1 (SK831/6.3.34 puṁvadbhāva + prohibitions SK838/6.3.37, SK839/6.3.38, SK841/6.3.40, SK842/6.3.41): a fem pūrvapada → its masc bhāṣitapuṁska form before a fem uttara (दीर्घजङ्घा), with the prohibitions overriding it (ब्राह्मणीभार्यः/दत्ताभार्यः/पाचिकाभार्यः/सुकेशीभार्यः) — saṁjñā-marker model like SK746/6.3.42. `test_samasa_bahuvrihi.py` (17 cases). Detail: SK829/830 + 6.3.34/37/38/40/41 rows + `bahuvrihi_plan.md`.

**Next to be implemented:** Bahuvrīhi **B2 — additional formation + word order** (SK843/2.2.25 saṅkhyā, SK845/2.2.26 diś, SK846/2.2.27 sarūpa, SK848/2.2.28 + SK849–850/6.3.82–83 saha, SK898–900/2.2.35–37 word order); then B3/B4 (full samāsānta) + B-UI (session prompts in `bahuvrihi_plan.md`). Deferred: B0 physical pūrva-nipāta (2.2.30 + word order 2.2.35–37, tagging only); B1 6.3.35 तसिलादि / 6.3.36 क्यङ्मानिन् (affix-context, not bahuvrīhi) + 6.3.39 वृद्धिनिमित्त (needs taddhita-vṛddhi analysis) — Skipped rows. Tatpuruṣa deferrals unchanged — see the Skipped table + `tatpuruza_plan.md`.
...
| Category | Count |
|---|---|
| Sutras implemented | 559 |
| Sutras skipped / deferred | 164 |
