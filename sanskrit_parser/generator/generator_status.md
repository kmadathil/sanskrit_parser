...
**Next to be implemented:** SK 532 (4.1.78 अणिञोरनार्षयोर्…) — into the taddhita section (4.1.76 तद्धिताः adhikāra); deferred: SK 506-516 (4.1.50-61 — compound/svāṅga/antodātta-accent-conditioned ṅīṣ + the blocking rules 4.1.56-58; **SK511/4.1.55 now implemented** using neighbour-pada peeking (`llp`) — see implemented table; the rest still await accent modelling / svāṅga classification / the 4.1.56-58 prohibitions); 4.1.46/4.1.47 (बहुश्/भुवश् छन्दसि, Vedic-only); earlier deferrals: SK 465-468 (7.3.46-49, northern variants); 4.1.31 रात्रेश्चाजसौ (no SK#); the vārttika **वुग्युटावुवङ्यणोः सिद्धौ वक्तव्यौ** (carves vuk-augment, yuṭ-augment, uvaṅ, yaṇ out of 6.4.22 — they remain siddha to other ābhīya rules; not yet implemented).
...
| Stems with full vibhakti test tables | 304 |
...
| 511 | 4.1.55 | नासिकोदरौष्ठजङ्घादन्तकर्णशृङ्गाच्च | optional ṅīṣ after a compound ending in a svāṅga word (nāsikā/udara/oṣṭha/jaṅghā/danta/karṇa/śṛṅga). **First rule to use neighbour-pada peeking**: condition `llp: ?samAsaPurva` checks the left-neighbour pada is a compound pūrva-pada (set by as_purva_pada) — so it fires only inside a samāsa, not for any preceding vākya pada; the bare svāṅga word takes only ṭāp. Two-fork like 4.1.44/45 → तुङ्गकर्णी / तुङ्गकर्णा. The saha/nañ (4.1.57) & kroḍādi/bahvac (4.1.56) prohibitions remain deferred — rule is currently unguarded for those pūrvapadas (no such test) |
...
| 511 | 4.1.55 | नासिकोदरौष्ठजङ्घादन्तकर्णशृङ्गाच्च | **Implemented** (see above) — Partial: prohibitions deferred | Now implemented via neighbour-pada peeking (`llp: ?samAsaPurva` → compound pūrva-pada). The 4.1.56/57/58 prohibitions (kroḍādi/bahvac, saha/nañ/vidyamāna-pūrva, nakha/mukha-saṃjñā) are still deferred, so the rule over-fires for those (untested) pūrvapadas |
...
| tuNgakarRA | f | SK511 (4.1.55) — samāsa, llp peek | [as_purva_pada(tuNga), luk_sup, in_compound(karRa), strI_abs]; 4.1.55 reads the pūrva-pada via `llp` → optional NIz → तुङ्गकर्णी / तुङ्गकर्णा (both forks) |
