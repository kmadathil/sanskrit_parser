...
**Last implemented:** **Bahuvrīhi अप् 5.4.116 + gandha 5.4.136/137.** अप् after a पूरणी/प्रमाणी uttara → स्त्रीप्रमाणः, कल्याणीपञ्चमाः; the गन्ध→इ cluster split three ways (5.4.135 pūrva-list, 5.4.136 अल्प sense, 5.4.137 उपमान). **5.4.135 was NARROWED** from ANY `=gandha` to its pūrva list (it had been over-firing on तीव्र/घृत and hiding 5.4.136/137); **6.3.34 gained its own अपूरणी guard** (no puṁvadbhāva before an ordinal, कल्याणीपञ्चमाः); the `gandha` stem's SLP1 encoding was corrected. Zero regressions.

**Next to be implemented:** **B3/B4 remaining** — gandha 5.4.136/137 DONE; still open: kakud 5.4.147–149, jambhā/dakṣiṇerma nipātanas (5.4.125/126). Then reciprocal इच् SK866/5.4.127 (केशाकेशि: needs 2.2.27 sarūpa + 6.3.137 + avyaya tagging, **not** reduplication — and it unlocks 6.4.146 ओर्गुणः / बाहूबाहवि). Then the formation deferrals needing **physical pūrva-nipāta (2.2.30)**: SK846/2.2.27, SK898–900/2.2.35–37, B0 reorder, B1 6.3.35/36/39. Latent gaps: **1.2.48's `?pum_abs` gate** (blocks upasarjana shortening — बहुनाडिः; would make 7.4.14 load-bearing) and **5.4.153's नदी arm keying on `?NI` not the 1.4.3 saṁjñā** (excludes तन्त्री). Tatpuruṣa deferrals unchanged.
