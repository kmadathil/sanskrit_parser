...
| 832/834/835/844/847/851/856–862/866/890/892/894–897 | 5.4.73,116,118–122,127,152,156,157,159,160, 7.4.13–15, 6.4.142/146, 8.4.3/28 | (bahuvrīhi samāsānta — affix insertion, remaining) | For later (bahuvrīhi B3 cont.) — done: कप् core (5.4.151 उरःप्रभृति + gaṇa, 5.4.153 नद्यृतश्च, 5.4.154 vivakṣā, 5.4.155), षच् (5.4.113/114/115), अप् (5.4.117), इच् (5.4.128), अनिच् (5.4.124) | Remaining families: अच् (5.4.118/119 नासिका→नस् — the ā-stem→a-stem substitution mismatches the inserted sup → प्रनस without visarga, AND the 8.4.3/28 ṇatva does not fire across the compound; needs sup re-insert + compound ṇatva), असिच् (5.4.122, s-stem dīrgha gap), डच् (5.4.73, accent-only surface, + 6.4.142 ति-lopa), अप् 5.4.116 (pūraṇī pl), इच् reciprocal (5.4.127, needs reduplication), minor कप् (5.4.152/156/157/159/160), 7.4.13–15 (net no-op for कप्), 6.4.146 ओर्गुणः. Each is one `_SAMASANTA_AFFIXES` entry + a Pratyaya + a rule |
