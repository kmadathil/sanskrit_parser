...
**Next to be implemented:** SK 500 (4.1.42 जानपदकुण्डगोण… — ākṛtigaṇa gaurādi-type list, ṅīṣ); deferred: SK 465-468 (7.3.46-49, northern variants); 4.1.31 रात्रेश्चाजसौ (no SK#); the vārttika **वुग्युटावुवङ्यणोः सिद्धौ वक्तव्यौ** (carves vuk-augment, yuṭ-augment, uvaṅ, yaṇ out of 6.4.22 — they remain siddha to other ābhīya rules; not yet implemented).
...
| Category | Count |
|---|---|
| Sutras implemented | 355 |
| Sutras skipped / deferred | 60 |
| Sutras uncatalogued / not yet planned | ~67 |
| **Total sutras accounted for** | **~459** |
| Stems with full vibhakti test tables | 249 |
