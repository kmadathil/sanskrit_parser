...
| Category | Count |
|---|---|
| Sutras implemented | 394 |
| Sutras skipped / deferred | 68 |
| Sutras uncatalogued / not yet planned | ~65 |
| **Total sutras accounted for** | **~527** |
...
| 633 | 2.3.36 | सप्तम्यधिकरणे च | vibhakti (K7): kAraka_aDikaraRa → viBakti_7; च arm semantic_dUrAntika (वनस्य दूरे), **overrides 2.3.46** for the non-kāraka dūra/antika arm. Also the saptamī default for the K7 adhikaraṇa-fork rules |
| 634 | 2.3.37 | यस्य च भावेन भावलक्षणम् | vibhakti (K7, sati-saptamī): each member of an absolute pair both tagged semantic_BAvalakzaRa, firing on a noun whose adjacent llp/rrp partner is also semantic_BAvalakzaRa → viBakti_7, **overrides 2.3.46** → गोषु दुह्यमानासु गतः |
| 635 | 2.3.38 | षष्ठी चानादरे | vibhakti (K7, **vibhāṣā — fork**): semantic_Seza + semantic_anAdara → viBakti_7 `optional: true` **overrides 2.3.50**; apply ⇒ saptamī (रुदति), skip ⇒ 2.3.50 ṣaṣṭhī (रुदतः) |
| 636 | 2.3.39 | स्वामीश्वराधिपतिदायादसाक्षिप्रतिभूप्रसूतैश्च | vibhakti (K7, **vibhāṣā — fork**): semantic_Seza + a yoga-word (=svAmin/=ISvara/=aDipati/=dAyAda/=sAkzin/=pratiBU/=prasUta via llp/rrp) → viBakti_7 `optional: true` **overrides 2.3.50**; गवां/गोषु वा स्वामी |
| 637 | 2.3.40 | आयुक्तकुशलाभ्यां चासेवायाम् | vibhakti (K7, **vibhāṣā — fork**): semantic_Seza + semantic_AsevA + =Ayukta/=kuSala via llp/rrp → viBakti_7 `optional: true` **overrides 2.3.50**; पूजने/पूजनस्य वा कुशलः |
| 638 | 2.3.41 | यतश्च निर्धारणम् | vibhakti (K7, **vibhāṣā — fork**): semantic_Seza + semantic_nirDAraRa → viBakti_7 `optional: true` **overrides 2.3.50**; नृणां/नृषु वा ब्राह्मणः श्रेष्ठः |
| 639 | 2.3.42 | पञ्चमी विभक्ते | vibhakti (K7): semantic_viBakta (nirdhāraṇa by separation) → viBakti_5, **overrides 2.3.46** → माथुराः पाटलिपुत्रकेभ्यः |
| 640 | 2.3.43 | साधुनिपुणाभ्यामर्चायां सप्तम्यप्रतेः | vibhakti (K7): semantic_arcA + =sADu/=nipuRa via llp/rrp → viBakti_7, **overrides 2.3.46** → मातरि साधुः (अप्रतेः prati-yoga blocking vārttika deferred) |
| 641 | 2.3.44 | प्रसितोत्सुकाभ्यां तृतीया च | vibhakti (K7, **vibhāṣā — fork**): semantic_prasitotsuka (+semantic_ADAra) → viBakti_3 `optional: true` **overrides 2.3.36**; apply ⇒ tṛtīyā (हरिणा), skip ⇒ 2.3.36 saptamī (हरौ) |
| 642 | 2.3.45 | नक्षत्रे च लुपि | vibhakti (K7, **vibhāṣā — fork**): semantic_nakzatralup (+semantic_ADAra) → viBakti_3 `optional: true` **overrides 2.3.36**; मूलेन/मूले (taddhita-lup itself deferred, modelled on plain stem मूल) |
| 643 | 2.3.7 | सप्तमीपञ्चम्यौ कारकमध्ये | vibhakti (K7, **vibhāṣā — fork**): semantic_kArakamaDya kāla/adhvan between two śaktis (+semantic_ADAra) → viBakti_5 `optional: true` **overrides 2.3.36**; द्व्यहे/द्व्यहात्, क्रोशे/क्रोशात् |
| 644 | 1.4.97 | अधिरीश्वरे | kāraka saṁjñā (K7): =aDi + semantic_ESvara + rp ?!kfYi → karmapravacanIya +kp_para +kp_saptamI → (2.3.9) अधि भुवि रामः / अधि रामे भूः. rp ?!kfYi defers to 1.4.98 before √kṛ |
| 645 | 2.3.9 | यस्मादधिकं यस्य चेश्वरवचनं तत्र सप्तमी | vibhakti (K7): noun governed by a kp_saptamI karmapravacanīya (direction-keyed via llp/rrp, like 2.3.8) → viBakti_7, **overrides 2.3.8** → अधि भुवि, उप परार्धे. Also `id 1.4.87.1` (उपोऽधिके च, adhika arm): =upa + semantic_aDika → +kp_para +kp_saptamI |
| 646 | 1.4.98 | विभाषा कृञि | kāraka saṁjñā (K7, **vibhāṣā — fork**): =aDi + semantic_ESvara + rp ?kfYi → karmapravacanIya `optional: true` (else gati) → अधि (माम्) अधिकरिष्यति. Saṁjñā-level only — surface deferred (no tiṅanta for adhi-√kṛ) |
...
| 551 | 1.4.87 | upa adhika → saptamī | **Done (K7)** — the adhika arm (id `1.4.87.1`) is now implemented | =upa + semantic_aDika → +kp_para +kp_saptamI → 2.3.9 saptamī (उप परार्धे हरेर्गुणाः); the K2 hīna arm (→ dvitīyā) is unchanged |
| 633 | 2.3.36 vārtt. | क्तस्येन्विषयस्य / साध्वसाधुप्रयोगे / निमित्तात्कर्मयोगे | Deferred (K7) — śeṣa-pratiṣedha vārttikas under SK633 | अधीती व्याकरणे (kta+in → karman saptamī); साधुः कृष्णो मातरि; चर्मणि द्वीपिनं हन्ति (nimitta-yoga saptamī) — narrow vārttika senses, deferred |
| 640 | 2.3.43 vārtt. | अप्रत्यादिभिरिति वक्तव्यम् | Deferred (K7) — prati/paryanu-yoga blocking | sādhu/nipuṇa with prati/paryanu (मातरं प्रति साधुः) — the bare arcā saptamī (मातरि साधुः) is implemented |
| 642 | 2.3.45 | taddhita-lup machinery | Deferred (K7) — taddhita lup not modelled (karaka_plan.md §6) | नक्षत्रे च लुपि vibhakti (मूलेन/मूले) is implemented on the **plain stem** मूल; the lup-elision of the taddhita suffix itself awaits taddhita-lup support |
| 646 | 1.4.98 | adhi-√kṛ surface | Deferred (K7) — no tiṅanta for adhi-√kṛ | the विभाषा कृञि saṁjñā fork is implemented; the surface अधिकरिष्यति enters as a pre-formed pada (karaka_plan.md §6) |
