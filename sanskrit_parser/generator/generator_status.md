...
**Last implemented:** **Bahuvrīhi Phases B0–B4 (partial).** B0 (SK829/830): spine + core formation + the one new mechanism, **anyapadārtha (external-referent) gender** (`?referent_*` + `?samasa_liNga_locked`); पीताम्बरः/पीताम्बरा/पीताम्बरम्. B1 (SK831/6.3.34 + prohibitions): puṁvadbhāva दीर्घजङ्घा/ब्राह्मणीभार्यः. B2 (SK848/2.2.28 + 6.3.82/83 saha; SK845/2.2.26 diś): सपुत्रः/सहपुत्रः, दक्षिणपूर्वा. **B3 samāsānta** (generalized `_SAMASANTA_AFFIXES` map): कप् core (SK891/5.4.154 बहुयशस्कम्/बहुयशः, SK889/5.4.151 व्यूढोरस्कः, SK893/5.4.155 saṁjñā), षच् (SK852/5.4.113 दीर्घसक्थः, SK854/5.4.115 द्विमूर्धः), अप् (SK855/5.4.117 बहिर्लोमः), इच् (SK867/5.4.128 द्विदण्डि). **B4 ādeśa/lopa/nipātana** (pre-pass uttara-substitution): jñu (SK868/5.4.129 प्रज्ञुः, SK869/5.4.130 opt ऊर्ध्वज्ञुः), anaṅ (SK870/5.4.132 सुधन्वा), anic (SK863/5.4.124 कल्याणधर्मा), गन्ध→id (SK874/5.4.135 सुगन्धिः), पाद (SK879/5.4.140 द्विपात्), kakud (SK884/5.4.146 प्राप्तककुत्), हृद् (SK888/5.4.150 सुहृत्). `test_samasa_bahuvrihi.py` (35 cases). Detail: the 5.4.113/115/117/128–150/151/154/155 + 6.3.34/… + 2.2.24/26/28 rows + `bahuvrihi_plan.md`.

**Next to be implemented:** **B3/B4 remaining samāsānta** — B3: अच् (नासिका→नस् + 8.4.3/28 ṇatva), असिच्/अनिच्, डच्, reciprocal इच् (5.4.127), अप् 5.4.116, minor कप् (5.4.152/153/156/157/159/160, 7.4.13–15); B4: datṛ (5.4.141 द्विदन्, needs दतृ न्-decl.), niṅ (5.4.134, needs 6.1.66), kakud-lopa (5.4.146–149), गन्ध 5.4.136/137, dhanus 5.4.133, jambhā/dakṣiṇerma nipātanas (grouped Skipped rows — each is a `_SAMASANTA_AFFIXES` entry or an `rc→""`/`r→…` uttara-substitution); then **B-UI**. Deferred: B2 SK843/2.2.25 (→ḍac), SK846/2.2.27 (→ic), SK898–900/2.2.35–37 (vyadhikaraṇa + physical pūrva-nipāta 2.2.30); B0 physical reorder; B1 6.3.35/36/39; masc s-stem 6.4.14 dīrgha under gender-override (बहुयशाः → B3 uses a neuter referent). Tatpuruṣa deferrals unchanged.
