...
2026-06-27 kāraka review fixes, and the avyayībhāva samāsa (SK 647–683, S0–S4 + composer/CLI)
— are recorded in the Implemented-Sutras tables below, in `karaka_plan.md` /
`tatpuruza_plan.md`, and in git history._

**Last implemented:** Tatpuruṣa samāsa, Phases **T4/T5/T-liṅga/T-UI** (the tatpuruṣa prakaraṇa is now complete through the composer). **T4 prādi/gati** — 2.2.18 कुगतिप्रादयः (a कु/गति/प्रादि avyaya pūrva + noun → tatpuruṣa: प्राचार्यः, कुपुरुषः, अतिमालः; the pūrva is ?nipAta → 1.1.37 avyaya, so its sup luks; reuses 1.2.43 + 2.4.26). **T5 samāsānta** — 5.4.91 राजाहःसखिभ्यष्टच् (rājan-arm: परमराजः, टच् → a-stem, न-lopa 6.4.144 as उपराजम्) via the proven ?samasanta_TaC + `_insert_samasanta` path, + 6.3.46 आन्महतः (महत्→महा pre-pass pūrva-substitution → महाराजः). **T-liṅga** — 2.4.29 रात्राह्नाहाः पुंसि (ahan-family tatpuruṣa → masculine, override of 2.4.26 via ?samasa_liNga_locked; structure/trace-verified). **T-UI** — CLI `-k … vN` supplies a member's vigraha vibhakti + the pre-pass summary prints ?tatpuruza/?karmaDAraya/?naY; the Vākya Composer flows the pūrva `vibhakti` through `toSpec`, flattens the nested samasta_pada for the compound-type readout (?tatpuruza/?karmaDAraya), and has कृष्णश्रितः/राजपुरुषः/नीलोत्पलम् gallery presets. Details: SK-order rows 761/788/807/814 + `tatpuruza_plan.md`.

**Next to be implemented:** The tatpuruṣa prakaraṇa (SK 684–828) is complete for the implemented scope; next is the following samāsa type (bahuvrīhi, SK 829+). **T4 deferral:** upapada (2.2.19 उपपदमतिङ् / 3.1.92) — needs the kṛt-pratyaya machinery (कुम्भकारः = कुम्भ+√कृ+अण्), out of samāsa scope; the gati long-tail (1.4.66, 1.4.70–79 — only the core ऊर्यादि/पुरस्/अस्तम् feeds 2.2.18, carried as the intrinsic ?gati tag). **T5 deferrals:** the ahar/sakhi arms of 5.4.91 (द्व्यहः — the ahar टच् collides with the existing dvyahna न्-retention, which keeps the samāsānta wac non-ट-marked → द्व्यह्न, SK238), 5.4.86 अङ्गुलि / 5.4.94 an-final / 5.4.101 khārī (stems not added). **T-liṅga deferrals:** 2.4.19 तत्पुरुषोऽनञ्कर्मधारयः (napuṁsaka only in the 2.4.17 saṃjñā-doubtful domain — inert without saṃjñā tagging, and would wrongly napuṁsaka-ise ordinary masc tatpuruṣas), 2.4.30 अपथं नपुंसकम् (needs the pathin अच् samāsānta 5.4.74), 2.4.31 अर्धर्चाः पुंसि च (needs the अर्धर्चादि stems); the full द्व्यहः a-stem surface awaits the ahar टच्. **T3 deferrals:** the 6.3.75/6.3.77 prakṛtibhāva exceptions (नभ्राट्…/नगः; Skipped table); अब्राह्मणेन is the correct instrumental (the ण of ब्राह्मण blocks the र-triggered ṇatva on the -ena न), so the nañ vibhakti sweep uses अनश्व. **T2 deferrals:** त्रिभुवनम् (cross-member ṇatva needs 8.4.3, a pre-existing engine gap, same family as चोरभयेन); the full कल्याणी→कल्याण puṃvadbhāva ṅīp-strip; 2.1.33–35, 2.1.42–48, 2.2.9–11, स्तोकान्मुक्तः aluk. (Kāraka and strī/taddhita deferrals remain in the Skipped table.)
...
| 730 | 2.1.52 | संख्यापूर्वो द्विगुः | Tatpuruṣa (**T2** dvigu, `bahiranga: -1`): a saṅkhyā-pūrva (?saMKyA) tatpuruṣa is a DVIGU (fused vidhi + saṁjñā). Forms पञ्च+गो, त्रि+लोक, त्रि+भुवन and sets ?dvigu; the tag rides to the merged stem (join_objects Tier-3) so the existing 4.1.21 (SK479) ṅīp fires on a **real dvigu** (त्रिलोकी), replacing the in_compound shim. Excludes the vaṁśya/nadī senses (2.1.19/2.1.20 avyayībhāva apavādas → द्विमुनि, द्विगङ्गम्) |
...
| 814 | 2.4.29 | रात्राह्नाहाः पुंसि | Tatpuruṣa (**T-liṅga** gender exception, saṁjñā, `bahiranga: -1`): a रात्र/अह्न/अह-final (?ahan family) tatpuruṣa is MASCULINE, overriding the uttara's native gender (अहन् n.) and 2.4.26. Pre-pass override: set +pum, drop the native gender, lock (?samasa_liNga_locked, which `join_objects` honours). Gated ?!samAhAra + ?!samasa_napum so it does not clobber a समाहार dvigu (napum by 2.4.1, द्व्यहम्). The full a-stem SURFACE (द्व्यहः) awaits the deferred ahar टच् (5.4.91 ahar-arm); the gender override is structure/trace-verified. 2.4.19/30/31 deferred — Skipped table |
