...
**Next to be implemented:** SK 647 समर्थः पदविधिः opens the samāsa-prakaraṇam (out of kāraka scope). Kāraka deferrals (see Skipped table): the tiṅ sup-insertion branch (verbs enter as pre-formed padas), real abhidhāna detection (prayoga is an input tag), multi-clause/participle sentences, and assorted long-tail vārttikas across the chapter. Strī/taddhita thread: the SK 532-numbered taddhita section (4.1.76 तद्धिताः adhikāra), with SK 508/509/516 and the वुग्युटावुवङ्यणोः vārttika deferred.
