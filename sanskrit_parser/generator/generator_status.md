...
| 678 | 5.4.108 | अनश्च | Avyayībhāva (S4): an-final uttara → ?samasanta_TaC → TaC; with 6.4.144 (न-lopa) → उपराजम् (upa + rājan) |
| 679 | 6.4.144 | नस्तद्धिते | Avyayībhāva (S4): the न् of an an-stem aṅga drops before the TaC taddhita (overrides 6.4.134's an-ablaut in the taddhita context) → rāj + a → rāja → उपराजम् |
...
| 680 | 5.4.109 | नपुंसकादन्यतरस्याम् | Deferred (avyayībhāva S4) — optional TaC for a napuṁsaka uttara; its trigger is indistinguishable from the ?napum that 2.4.18 assigns to every avyayībhāva, so a faithful version needs the uttara's inherent gender tracked separately. Narrow long-tail (uttaras not already covered by 5.4.108/110/111/112) | napuṁsaka-uttara avyayībhāvas |
