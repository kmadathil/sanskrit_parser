...
| Category | Count |
|---|---|
| Sutras implemented | 414 |
| Sutras skipped / deferred | 71 |
| Sutras uncatalogued / not yet planned | ~65 |
| **Total sutras accounted for** | **~550** |
...
| 607 | 2.3.26 | षष्ठी हेतुप्रयोगे | vibhakti (K6): noun whose llp/rrp is a hetu-word (=hetoH/=hetunA) → viBakti_6, **overrides 2.3.46** → अन्नस्य हेतोः |
| 608 | 2.3.27 | सर्वनाम्नस्तृतीया च | vibhakti (K6, **vibhāṣā — pre-pass fork**): a ?sarvanAma cause with a hetu-word → viBakti_3 `optional: true`, else fall-through to 2.3.26 ṣaṣṭhī → केन हेतुना / कस्य हेतोः |
| 609 | 2.3.30 | षष्ठ्यतसर्थप्रत्ययेन | vibhakti (K6): noun whose llp/rrp is an atasartha word (=dakziRatas) → viBakti_6, **overrides 2.3.46** → ग्रामस्य दक्षिणतः |
| 610 | 2.3.31 | एनपा द्वितीया | vibhakti (K6, **vibhāṣā — pre-pass fork**): noun with an enap-anta word (=dakziRena) → viBakti_2 `optional: true`, else the 2.3.31.1 yoga-vibhāga companion → viBakti_6 → दक्षिणेन ग्रामं / ग्रामस्य |
| 611 | 2.3.34 | दूरान्तिकार्थैः षष्ठ्यन्यतरस्याम् | vibhakti (K6, **vibhāṣā — pre-pass fork**): noun with a dūra/antika word (=dUram/=nikawam) → viBakti_6 `optional: true`, else the 2.3.34.1 companion → viBakti_5 pañcamī → दूरं ग्रामस्य / ग्रामात् |
...
| 613 | 2.3.52 | अधीगर्थदयेशां कर्मणि | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp ?aDIgartha → viBakti_6, **overrides 2.3.50** → मातुः स्मरति |
| 614 | 2.3.53 | कृञः प्रतियत्ने | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp ?kfYpratiyatna → viBakti_6, **overrides 2.3.50** → ओदनस्योपस्कुरुते |
| 615 | 2.3.54 | रुजार्थानां भाववचनानामज्वरेः | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp ?rujArTa → viBakti_6, **overrides 2.3.50** → चौरस्य रुजति |
| 616 | 2.3.55 | आशिषि नाथः | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp ?nATASis → viBakti_6, **overrides 2.3.50** → सर्पिषो नाथते |
| 617 | 2.3.56 | जासिनिप्रहणनाटक्राथपिषां हिंसायाम् | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp ?hiMsArTa → viBakti_6, **overrides 2.3.50** → चौरस्योज्जासयति |
| 618 | 2.3.57 | व्यवहृपणोः समर्थयोः | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp ?vyavahfpaR → viBakti_6, **overrides 2.3.50** → शतस्य व्यवहरति |
| 619 | 2.3.58 | दिवस्तदर्थस्य | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp [and ?divtadarTa ?!upasfzwa] → viBakti_6, **overrides 2.3.50** → शतस्य दीव्यति (non-upasṛṣṭa) |
| 620 | 2.3.59 | विभाषोपसर्गे | vibhakti (K6, **vibhāṣā — pre-pass fork**): kAraka_karma + rp [and ?divtadarTa ?upasfzwa] → viBakti_6 `optional: true`, **overrides 2.3.2**, else fall-through to 2.3.2 dvitīyā → शतस्य / शतं प्रतिदीव्यति |
| 621 | 2.3.61 | प्रेष्यब्रुवोर्हविषो देवतासंप्रदाने | vibhakti (K6, verb-conditioned śeṣa): semantic_Seza + rp ?prezyabrU → viBakti_6, **overrides 2.3.50** → छागस्य प्रेष्यति |
| 622 | 2.3.64 | कृत्वोर्थप्रयोगे कालेऽधिकरणे | vibhakti (K6): semantic_Seza (kāla adhikaraṇa) + a kṛtvas-word llp/rrp (=paYcakftvas) → viBakti_6, **overrides 2.3.46/2.3.50** → पञ्चकृत्वोऽह्नः |
| 623 | 2.3.65 | कर्तृकर्मणोः कृति | vibhakti (K6, **kṛd-yoga**): semantic_Ipsitatama/svatantra whose llp/rrp governor carries [and ?kft ?!kft_aSazWI] → viBakti_6, **overrides 2.3.2/2.3.18** → ओदनस्य पाचकः, हरेः कृतिः. The ?!kft_aSazWI guard *is* the 2.3.69/70 prohibition (no positive rule) |
| 624 | 2.3.66 | उभयप्राप्तौ कर्मणि | **Deferred (K6)** — Skipped table: needs a genuine dual-kāraka kṛt-frame analysis (which of two prāpta kārakas is the karman), no kṛt-derivation yet |
| 625 | 2.3.67 | क्तस्य च वर्तमाने | vibhakti (K6, **kṛd-yoga**): semantic_svatantra whose llp/rrp governor carries ?kta_vartamAna (present-sense kta, re-permitted past the 2.3.69 niṣṭhā prohibition) → viBakti_6, **overrides 2.3.2/2.3.18** → राज्ञां मतः |
| 626 | 2.3.68 | अधिकरणवाचिनश्च | vibhakti (K6, **kṛd-yoga**): semantic_svatantra whose llp/rrp governor carries ?kta_aDikaraRa → viBakti_6, **overrides 2.3.2/2.3.18** → एतेषामासितम् |
| 627 | 2.3.69 | न लोकाव्ययनिष्ठाखलर्थतृनाम् | **Guard-realized (K6)** — no positive rule: the prohibited governors (laṭ-ādeśa/avyaya/niṣṭhā/khalartha/tṛn) carry ?kft_aSazWI, and the ?!kft_aSazWI guard on 2.3.65 keeps the ṣaṣṭhī off → दैत्यान् घातुको हरिः (हरिम्, dvitīyā via 2.3.2). Asserted via negative case |
| 628 | 2.3.70 | अकेनोर्भविष्यदाधमर्ण्ययोः | **Guard-realized (K6)** — no positive rule: the future-aka / ādhamarṇya-in governors carry ?kft_aSazWI (same ?!kft_aSazWI guard on 2.3.65) → व्रजं गामी (ग्रामम्, dvitīyā). Asserted via negative case |
| 629 | 2.3.71 | कृत्यानां कर्तरि वा | vibhakti (K6, **kṛd-yoga, vibhāṣā — pre-pass fork**): kAraka_kartA whose llp/rrp governor carries ?kftya → viBakti_6 `optional: true`, **overrides 2.3.18**, else fall-through to 2.3.18 tṛtīyā → मम/मे / मया सेव्यः |
...
| 624 | 2.3.66 | उभयप्राप्तौ कर्मणि | Deferred (K6) — needs dual-kāraka kṛt-frame analysis | when both kartṛ and karman are simultaneously prāpta in a kṛd-yoga (e.g. आश्चर्यो गवां दोहोऽगोपेन), only the karman takes ṣaṣṭhī; choosing *which* participant is the karman requires a genuine kṛt valency frame, not yet modelled (kṛt derivation deferred, karaka_plan.md §6) |
| 627 | 2.3.69 | न लोकाव्ययनिष्ठाखलर्थतृनाम् | Guard-realized (K6), not a positive rule | the prohibition is encoded as the ?!kft_aSazWI guard on 2.3.65 (prohibited governors — laṭ-ādeśa/avyaya/niṣṭhā/khalartha/tṛn — carry ?kft_aSazWI). Asserted via the negative case दैत्यान् घातुको हरिः → हरिम् (dvitīyā), 2.3.65 not fired |
| 628 | 2.3.70 | अकेनोर्भविष्यदाधमर्ण्ययोः | Guard-realized (K6), not a positive rule | future-aka / ādhamarṇya-in governors carry ?kft_aSazWI; same ?!kft_aSazWI guard on 2.3.65. Asserted via व्रजं गामी → ग्रामम् (dvitīyā) |
...
101 cases from the SK commentary. **K0 (26, SK532–537, 559–561, 606):** हरिं भजति
...
the non-saṁjñā negative, धनेन कुलम् (hetu). **K4 (11, SK569–585, sampradāna +
caturthī):** हरये रोचते भक्तिः, देवदत्ताय शतं धारयति, हरये क्रुध्यति, अभिक्रुध्यति हरिम्
(param 1.4.38>1.4.37), विप्राय गां ददाति, नमो देवेभ्यः, ग्रामं/ग्रामाय गच्छति
(2.3.12 **vibhāṣā**), शताय/शतेन परिक्रीणीते (1.4.44 **vibhāṣā**), तृणं/तृणाय मन्यते
(2.3.17 **vibhāṣā**) + the rucyartha/krudh negative. **K6 (23, SK607–631, ṣaṣṭhī):**
अन्नस्य हेतोः (2.3.26), केन हेतुना / कस्य हेतोः (2.3.27 **vibhāṣā**), ग्रामस्य दक्षिणतः
(2.3.30), दक्षिणेन ग्रामं/ग्रामस्य (2.3.31 **vibhāṣā** + 2.3.31.1 companion), दूरं
ग्रामस्य/ग्रामात् (2.3.34 **vibhāṣā** + 2.3.34.1 pañcamī companion), सर्पिषो जानीते /
मातुः स्मरति / ओदनस्योपस्कुरुते / चौरस्य रुजति / सर्पिषो नाथते / चौरस्योज्जासयति / शतस्य
व्यवहरति / शतस्य दीव्यति / छागस्य प्रेष्यति (verb-conditioned śeṣa, 2.3.51–58/61),
शतस्य/शतं प्रतिदीव्यति (2.3.59 **vibhāṣā**), पञ्चकृत्वोऽह्नः (2.3.64), ओदनस्य पाचकः /
हरेः कृतिः (2.3.65 kṛd-yoga), राज्ञां मतः (2.3.67), एतेषामासितम् (2.3.68), मम/मे / मया
सेव्यः (2.3.71 **vibhāṣā**), plus the 2.3.69/70 prohibition negatives दैत्यान् घातुको
हरिः (हरिम्) and व्रजं गामी (ग्रामम्) — 2.3.65 must NOT fire. The vibhāṣā cases assert
*both* branches (karaka_log aggregated by index across forks; surface set via
output()). Three assertion levels per case (kAraka_* tag, viBakti_N tag set, surface
forms) + fired-trace checks + per-word negatives.
