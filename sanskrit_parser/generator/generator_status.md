...
**Last implemented:** **Bahuvrīhi Phases B0–B4 (partial) + B-UI.** B0 (SK829/830): spine + core formation + the one new mechanism, **anyapadārtha (external-referent) gender** (`?referent_*` + `?samasa_liNga_locked`); पीताम्बरः/पीताम्बरा/पीताम्बरम्. B1 (SK831/6.3.34 + prohibitions): puṁvadbhāva दीर्घजङ्घा/ब्राह्मणीभार्यः. B2 (SK848/2.2.28 + 6.3.82/83 saha; SK845/2.2.26 diś): सपुत्रः/सहपुत्रः, दक्षिणपूर्वा. **B3 samāsānta** (generalized `_SAMASANTA_AFFIXES` map): कप् (SK891/5.4.154 बहुयशस्कम् via `?kap_vivakzA` / बहुयशः without, SK889/5.4.151 उरःप्रभृति gaṇa व्यूढोरस्कः/प्रियसर्पिष्कः, SK833/5.4.153 नद्यृतश्च बहुकुमारीकः/बहुमातृकः, SK893/5.4.155 saṁjñā), षच् (SK852/5.4.113 दीर्घसक्थः, SK853/5.4.114 पञ्चाङ्गुलम्, SK854/5.4.115 द्विमूर्धः), अप् (SK855/5.4.117 बहिर्लोमः), इच् (SK867/5.4.128 द्विदण्डि). **B4 ādeśa/lopa/nipātana** (pre-pass uttara-substitution): jñu (SK868/5.4.129 प्रज्ञुः, SK869/5.4.130 opt ऊर्ध्वज्ञुः), anaṅ (SK870/5.4.132 सुधन्वा), anic (SK863/5.4.124 कल्याणधर्मा), गन्ध→id (SK874/5.4.135 सुगन्धिः), पाद (SK879/5.4.140 द्विपात्), kakud (SK884/5.4.146 प्राप्तककुत्), हृद् (SK888/5.4.150 सुहृत्). **B-UI:** CLI `--referent-linga <pum|strI|napum>` (`cmd_line.prepare_bahuvrihi`) + Vākya-Composer API (`/api/karaka` `referent_linga` → `run_karaka`/`_apply_bahuvrihi`) + a referent-liṅga dropdown in `karaka.html`; the composer already renders the `?bahuvrIhi` compound type. `test_samasa_bahuvrihi.py` (44 cases, incl. CLI smoke; every SK829–900 sūtra accounted — implemented or explicit Skipped row). Detail: the 5.4.113/115/117/128–150/151/154/155 + 6.3.34/… + 2.2.24/26/28 rows + `bahuvrihi_plan.md`.

**Next to be implemented:** **B3/B4 remaining samāsānta** — the ā-stem→i/a-stem substitutions (niṅ जाया→जानि 5.4.134, अच् नासिका→नस् 5.4.118/119) need only a **one-line `update: orp: [-Ap, -strI]`** on the ādeśa rule: the substitution rewrites the stem string but leaves the source's `?Ap`, which drives ā-stem su-elision → जानि/प्रनस lose their visarga (verified: with the clear, 5.4.134 gives **युवजानिः**); अच् additionally needs the 8.4.3/28 **ṇatva across the compound**. असिच् (5.4.122) + the masc s-stem बहुयशाः need **6.4.14's `-as` arm widened beyond `+u`** — as implemented it fires only for u-it stems (matup/ktavatu/īyasun), so a plain अस्-noun gives यशः even standalone; that is a general as-stem declension change needing its own regression pass. datṛ (5.4.141 द्विदन्) needs the **दतृ न्-declension**; डच् (5.4.73) is accent-only; reciprocal इच् (5.4.127 केशाकेशि) needs reduplication; minor कप् (5.4.152/153/156/157/159/160, 7.4.13–15) + अप् 5.4.116 (pūraṇī pl). Also: B2 SK843/2.2.25 (→ḍac), SK846/2.2.27 (→ic), SK898–900/2.2.35–37 (vyadhikaraṇa + physical pūrva-nipāta 2.2.30); B0 physical reorder; B1 6.3.35/36/39. Tatpuruṣa deferrals unchanged.
...
| 833 | 5.4.153 | नद्यृतश्च | Bahuvrīhi (**B3** samāsānta कप्, `bahiranga: -1`): a bahuvrīhi whose uttara is a नदी-word (`?NI`) or ऋ-final (`?svasrAdi`) takes कप् → बहुकुमारीकः, बहुनदीकः, बहुमातृकः. SK834/7.4.13 + SK835/7.4.14 net to no change for कप्, so the ई/ऋ is retained without them |
...
| 852/854 | 5.4.113, 5.4.115 | सक्थ्यक्ष्णोः स्वाङ्गात्षच् / द्वित्रिभ्यां ष मूर्ध्नः | Bahuvrīhi (**B3** samāsānta षच्, `bahiranga: -1`): a svāṅga सक्थि/अक्षि → षच् (दीर्घसक्थः; i-lopa 6.4.148), and द्वि/त्रि + मूर्धन् → ष (द्विमूर्धः; न-lopa 6.4.144). Sets `?samasanta_Sac` (→ `Sac` in `_SAMASANTA_AFFIXES`). A saṅkhyā pūrva carries NO vacana (`?nityadvivacana` vs forced vacana_1 → द्व) |
...
| 874 | 5.4.135 | गन्धस्येदुत्पूतिसुसुरभिभ्यः | Bahuvrīhi (**B4** samāsānta ādeśa, `bahiranga: -1`): the final of गन्ध final in a bahuvrīhi → इत् (i) → सुगन्धिः. Uttara-substitution गन्ध→गन्धि |
...
| 843 | 2.2.25 | संख्ययाऽव्ययासन्नादूराधिकसंख्याः संख्येये | Deferred (bahuvrīhi B2) — surface needs 5.4.73 ḍac (B3) | saṅkhyā/āsanna/adūra/adhika + a number → bahuvrīhi (उपदशाः); the डच् samāsānta that gives the surface lands in B3 |
| 846 | 2.2.27 | तत्र तेनेदमिति सरूपे | Deferred (bahuvrīhi B2) — surface needs 5.4.127 ic (B4) | homonym-reciprocity bahuvrīhi (केशाकेशि); the इच् samāsānta + reduplication land in B4 |
...
| 832/834/835/844/847/851/856–862/866/890/892/894–897 | 5.4.73,116,118–122,127,152,156,157,159,160, 7.4.13–15, 6.4.142/146, 8.4.3/28 | (bahuvrīhi samāsānta — affix insertion, remaining) | For later (bahuvrīhi B3 cont.) — done: कप् core (5.4.151 उरःप्रभृति + gaṇa, 5.4.153 नद्यृतश्च, 5.4.154 vivakṣā, 5.4.155), षच् (5.4.113/114/115), अप् (5.4.117), इच् (5.4.128), अनिच् (5.4.124) | Remaining families: अच् (5.4.118/119 नासिका→नस् — the substitution leaves the source's `?Ap`, which drives ā-stem su-elision → प्रनस without visarga; fixed by `update: orp: [-Ap, -strI]` on the rule, AND separately the 8.4.3/28 ṇatva must fire across the compound), असिच् (5.4.122 — needs 6.4.14's `-as` arm widened beyond `+u`; a plain अस्-noun gives यशः even standalone), डच् (5.4.73, accent-only surface, + 6.4.142 ति-lopa), अप् 5.4.116 (pūraṇī pl), इच् reciprocal (5.4.127, needs reduplication), minor कप् (5.4.152/156/157/159/160), 7.4.13–15 (net no-op for कप्), 6.4.146 ओर्गुणः. Each is one `_SAMASANTA_AFFIXES` entry + a Pratyaya + a rule |
| 864–888 | 5.4.125–150, 6.1.66 | (bahuvrīhi samāsānta — ādeśa/lopa/nipātana, remaining) | For later (bahuvrīhi B4) — done: jñu (5.4.129/130), anaṅ (5.4.132 सुधन्वा), anic (5.4.124 कल्याणधर्मा), gandha→id (5.4.135), pāda (5.4.140), kakud (5.4.146 प्राप्तककुत्), hṛd (5.4.150) | Remaining, deferred on declension gaps: datṛ (5.4.141 — दतृ न्-decl., engine gives द्विदत्), niṅ (5.4.134 jāyā→jani — the substitution leaves the source's `?Ap` → जानि without visarga; a one-line `update: orp: [-Ap, -strI]` fixes it, VERIFIED giving युवजानिः), kakud 5.4.147–149, gandha 5.4.136/137, dhanus 5.4.133 (the शतधनुः fork needs suppressing nitya 5.4.132), jambhā/dakṣiṇerma nipātanas (5.4.125/126) |
