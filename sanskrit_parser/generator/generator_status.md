...
| 856/857 | 5.4.118, 8.4.3 | अञ् नासिकायाः संज्ञायां नसं चास्थूलात् / पूर्वपदात्संज्ञायामगः | Bahuvrīhi (**B3** अच् + **cross-compound ṇatva**): a नासिका-final SAṀJÑĀ bahuvrīhi → नस् (`-Ap` clear, marks `?saMjYA_nas`), and 8.4.3 ṇatva-ises the न across the pūrva/uttara boundary → **द्रुणसः**. The ṇatva is enabled the same way as SK307/8.4.12 — set `?samasta_Ratva` on the uttara → `?samasta_Ratva_pada` → arm B of 8.4.1/8.4.2 (arm A is blocked by `?merged_pada`). Keyed on `?saMjYA_nas` so it stays confined to the नस् (a general pūrvapada ṇatva would wrongly give *त्रिभुवणम्*). अगः / अस्थूलात् not modelled |
...
| 832/834/835/844/847/851/856–862/866/890/892/894–897 | 5.4.73,116,118–122,127,152,156,157,159,160, 7.4.13–15, 6.4.142/146, 8.4.3/28 | (bahuvrīhi samāsānta — affix insertion, remaining) | For later (bahuvrīhi B3 cont.) — done: कप् core (5.4.151 उरःप्रभृति + gaṇa, 5.4.153 नद्यृतश्च, 5.4.154 vivakṣā, 5.4.155), षच् (5.4.113/114/115), अप् (5.4.117), इच् (5.4.128), अनिच् (5.4.124) | Remaining families: (अच् 5.4.118/119 + the 8.4.3/8.4.28 cross-compound ṇatva are all DONE — द्रुणसः/प्रणसः/उन्नसः), (असिच् 5.4.122 fully DONE incl. the nañ arm — सुप्रजाः/सुमेधाः/अप्रजाः/अमेधाः), डच् (5.4.73, accent-only surface, + 6.4.142 ति-lopa), अप् 5.4.116 (pūraṇī pl), इच् reciprocal (5.4.127, needs reduplication), minor कप् (5.4.152/156/157/159/160), 7.4.13–15 (net no-op for कप्), 6.4.146 ओर्गुणः. Each is one `_SAMASANTA_AFFIXES` entry + a Pratyaya + a rule |
| 864–888 | 5.4.125–150, 6.1.66 | (bahuvrīhi samāsānta — ādeśa/lopa/nipātana, remaining) | For later (bahuvrīhi B4) — done: jñu (5.4.129/130), anaṅ (5.4.132 सुधन्वा), anic (5.4.124 कल्याणधर्मा), gandha→id (5.4.135), pāda (5.4.140), kakud (5.4.146 प्राप्तककुत्), hṛd (5.4.150) | Remaining, deferred on declension gaps: datṛ (5.4.141 — दतृ न्-decl., engine gives द्विदत्), (niṅ 5.4.134 is DONE — the `-Ap` clear gives युवजानिः), kakud 5.4.147–149, gandha 5.4.136/137, dhanus 5.4.133 (the शतधनुः fork needs suppressing nitya 5.4.132), jambhā/dakṣiṇerma nipātanas (5.4.125/126) |
